...
export default function ChatPage() {
    ...
    // Initialize Echo & subscribe to private channel
    useEffect(() => {
        ...
        channel.listen("MessageSent", (e) => {
            ...
            if (msg) setMessages(prev => [...(Array.isArray(prev) ? prev : []), msg]);
        });
        ...
        <Layout>
            <div className="md:px-10">
                ...
                <div className="border border-gray-200 rounded-2xl h-[60vh] md:h-[70vh] flex flex-col overflow-hidden shadow-md">
                    <div ref={listRef} className="flex-1 overflow-y-auto p-4 space-y-4 bg-white custom-scrollbar">
                        {loading ? (
